// src/components/Inventario/SalidaProductos.js
import { useState, useEffect } from 'react';
import { inventarioAPI } from '../../utils/api';

export default function SalidaProductos({ onSalidaRegistrada }) {
  ...
  return (
    <div className="salida-productos-component">
      {/* Alertas */}
      {alertas.mensaje && (
