// src/pages/inventario/entrada.js
import { useState, useEffect } from 'react';
import { useRouter } from 'next/router';
import { useAuth } from '../../hooks/useAuth';
import { inventarioAPI, productosAPI } from '../../utils/api';

export default function EntradaFactura() {
  ...
  const cargarDatosIniciales = async () => {
    try {
      ...
      // Cargar proveedores
      const responseProveedores = await productosAPI.obtenerProveedores();
  ...
  const actualizarProducto = (index, campo, valor) => {
    ...
    if (campo === 'cantidad' || campo === 'precio_compra') {
      ...
      // Calcular precio de venta con 10% de ganancia
  ...
  const registrarFactura = async () => {
    ...
    // Verificar número de factura antes de registrar
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="text-muted mb-0">
                Registrar productos de nuevas facturas al inventario
              </p>
            </div>
            <button 
                        ...
                        <tr key={producto.producto_id}>
                          <td>
                            <div>
                              ...
                              <br />
                              <small className="text-muted">
                                {producto.categoria_nombre} - {producto.unidades_por_paquete} unidades/{producto.medida}
                              </small>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <small className="text-muted">
                              Sugerido: ${(producto.precio_venta_sugerido || 0).toFixed(2)}
                            </small>
                          </td>
                          <td>
                            <input
              ...
              <div className="mt-4">
                <div className="alert alert-info">
                  ...
                  <ul className="mb-0">
                    ...
                    <li>El precio de venta se calcula automáticamente con 10% de ganancia</li>
                    <li>Puede personalizar el precio de venta si es necesario</li>
                    <li>Las devoluciones se restan automáticamente del stock</li>
                  </ul>
                </div>
              </div>
            </div>
